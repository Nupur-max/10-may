...
const DgcaLogBook = ({ navigation }) => {
    ...
    const totalCalculation = (monthData) => {
        ...
        monthData.map(d => {
            ...
            if (d.instructional !== "") {
                ...
                if (isNaN(totalinstructional1[0])) {
                    totalinstructional1 = '00:00'
                }
            }
        })
    ...
    const logStlDataToPrint = () => {
        ...
        var platFormcss = Platform.OS === "ios" ? '.ritz .waffle .s0{padding:0px 13px;}' : '.ritz .waffle .s0{padding:1px 13px;}'
        let htmlContent = '<html><body>'
        pdfData.map((monthData, index) => {
            ...
            } htmlContent += totalCalculation(monthData) + '' + prevDataCalculation(monthData) + '' + totalDateCalculation(monthData) + '</tbody>    </table>'+page2+'</div>'
