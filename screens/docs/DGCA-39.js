...
const DGCA39 = ({ navigation }) => {
    ...
    const getLogbookData = async () => {
        ...
        prePopulateddb.transaction(tx => {
            if (logOption == 'Logbook') {
                tx.executeSql('SELECT * from logbook WHERE user_id == "' + user.id + '" AND orderedDate BETWEEN "' + orderStart + '" AND "' + orderEnd + '" AND tag == "manual" ORDER BY orderedDate ASC', [], (tx, result) => {
    ...
    const monthTotal = () => {
        ...
        Object.entries(monthWise).map((monthData) => {
            ...
            htmlContent += '<tr style="height: 20px" class="dgca"> <td class="s0" dir="ltr">' + monthData[0] + '</td>                 <td class="s0" dir="ltr">' + dayDual1 + '</td>                <td class="s0" dir="ltr">solo</td>                <td class="s0" dir="ltr">' + nightDual1 + '</td>                <td class="s0" dir="ltr">solo</td>                <td class="s0" dir="ltr">' + dayUt1 + '</td>                <td class="s0" dir="ltr">' + daySic1 + '</td>                <td class="s0" dir="ltr">' + dayP1us1 + '</td>                <td class="s0" dir="ltr">' + dayPic1 + '</td>                <td class="s0" dir="ltr">' + nightUt1 + '</td>                <td class="s0" dir="ltr">' + nightSic1 + '</td>                <td class="s0" dir="ltr">' + nightP1us1 + '</td>                  <td class="s0" dir="ltr">' + nightPic1 + '</td>                <td class="s0" dir="ltr">' + totalT1 + '</td>       <td class="s0" dir="ltr">' + simTime1 + '</td>         <td class="s0" dir="ltr">' + actTime1 + '</td>                      <td class="s0" dir="ltr">synth</td>        <td class="s0" dir="ltr">' + instTime1 + '</td>                <td class="s0" dir="ltr"></td>            </tr>  '
        })
        for (let i = 0; i < 12 - Object.keys(monthWise).length; i++) {
            htmlContent += '<tr style="height: 20px" class="dgca" id=' + i + '>                <td class="s0" dir="ltr"></td>                <td class="s0" dir="ltr"></td>                <td class="s0" dir="ltr"></td>                <td class="s0" dir="ltr"></td>                <td class="s0" dir="ltr"></td>                <td class="s0" dir="ltr"></td>                <td class="s0" dir="ltr"></td>                <td class="s0" dir="ltr"></td>                <td class="s0" dir="ltr"></td>                <td class="s0" dir="ltr"></td>                <td class="s0" dir="ltr"></td>                <td class="s0" dir="ltr"></td>                <td class="s0" dir="ltr"></td>       <td class="s0" dir="ltr"></td>         <td class="s0" dir="ltr"></td>                <td class="s0" dir="ltr"></td>        <td class="s0" dir="ltr">synth</td>        <td class="s0" dir="ltr"></td>                <td class="s0" dir="ltr"></td>            </tr>  '
        }
